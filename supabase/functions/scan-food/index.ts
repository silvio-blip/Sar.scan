...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const promptDefinitivo =
      "Analisa esta imagem de comida e diz-me o que é e as suas calorias aproximadas.";
    ...
    return new Response(JSON.stringify({ sucesso: true, resultado: textoResposta }), {
